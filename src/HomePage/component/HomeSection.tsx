  ...
  return (
    <div className="flex pt-20 pl-20 pb-16 ">
      <div className="pt-40">
        ...
        <p className="text-sm">
          Join the best fitness program around. Sign up now for customized
          workouts today!
        </p>
      ...
      <div className="flex flex-col pt-32 pr-[188px] gap-7">
        <BenefitHome
          title="Science - based"
          description="programs by renowned coaches"
        ></BenefitHome>
        <BenefitHome
          title="Custom Workout"
          description="tracker to log your training and create routines"
        ></BenefitHome>
        <BenefitHome
          title="24/7 Consultation"
          description="to help you stay on track and motivated"
        ></BenefitHome>
